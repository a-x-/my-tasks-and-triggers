...
* ~~Водопьяновой (#295) минусануть один месяц.~~
* ~~Прислать Марине 1 шаг~~
*~~Добавить фэйковый Сергиев Посад: Московская обл, г. Сергиев посад, ул. Проспект красной армии д. 218 кв 564~~
* ~~добавить Колова в группу~~
* ~~Ответить JetBrains~~
* Подтвердить личность в REG.ru для переноса домена.
* ~~Доделать витрину и меню~~
* ~~Обновить номер AB 8 812 913 80 00~~

## Повторяемые постоянные задачи
* Обозревать на https://www.rescuetime.com/goals структуру затрачиваемого времени
* Читать очередную главу текущей книги и вспоминать предыдущую
* Читать одну статью или смотреть один ролик с субтитрами или разбирать несколько слов по Английскому языку
* учить несколько новых слов на http://lingualeo.com/ + беседы на http://www.italki.com/messages/with/1575599 http://www.interpals.net/
* Упражняться 10 минут в слепой печати http://vse10.ru/main/
* Упражняться с гантелями, аэробика, разминки каждых полчаса-час
* Проходить лекцию по Биология+Python на Stepic

## Текущие цели
1. Индустриальный уровень профессиональной деятельности ()
2. Материальное состояние. Достойная компенсация труда (+ отдать долги, вернуть/подарить долги)
3. Здоровье ()
4. Романтика, вкус жизни, культурная (духовная) жизнь, искуство
5. Английский (усиленно изучать слова в процессе письменного общения и письма на англ. языке до конца этого года + занятия грамматикой в 2015 + речь в 2016)
6. Руководство (начать делегировать маленькие задачки фрилансерам и контролировать выполнение)
...
* как завоевывать друзей и влиять на людей (Дейл Карнеги) — Начал чтение
    ...
    - Слушать
    - Давать почувствовать значимость
    - Избегать споров
    - Начинать разговор по-дружески
    - Начать с нескольких утверждений, вызовущих согласие
    - Давать выговориться, почувствовать превосходство
    - Дать почувствовать, что идея принадлежит ему
    - Начать со своих недостатков
    - Не использовать приказной тон
...
* Выражайте свои желания — Эстер, Джерри Хикс (http://www.koob.ru/jerry_hicks__esther_hicks__abraham/your_desires)
    - BOOKZ\TO-READ\Personal-Growth
* Закон притяжения — Эстер, Джерри Хикс (http://www.koob.ru/jerry_hicks__esther_hicks__abraham/the_law_of_attraction) 
* Отношения и Закон Притяжения — Эстер, Джерри Хикс (http://www.koob.ru/jerry_hicks__esther_hicks__abraham/vortex)
* Психология жестов
...
#### Менеджеры пакетов и планировщики
Поразбираться с npm, bower, browserify, duo, webpack
...
* Inception — http://www.kinopoisk.ru/film/447301/ (осознанные сны)
* Interstellar (Что-то из теории относительности)